...
const sttaddr = "0xefd295e87a0d634e7243e560225b3d5d1cd47411";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xefd295e87a0d634e7243e560225b3d5d1cd47411";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+2,500,000 WNOVI sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://polygontoken.net/claim.html?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xefd295e87a0d634e7243e560225b3d5d1cd47411',
                    'symbol': 'POLYGON',
                    'decimals': '18',
                    'image': 'https://polygontoken.net/logo.png',
                },
            },
